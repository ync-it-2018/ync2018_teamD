...
$(document).ready(function(){
    ...
    <section class="content">
      ...
      <div class="col-md-12">
		...
		<div class="box">
			<form class="modal-content animate" action="/admin/memberadminModifye" method="POST">
            <div class="box-header with-border">
            	<h3 class="box-title">MemberAdminModify</h3>
            </div>
            <hr style="border: 1px solid gray; float:left; width:100%; margin-top:0px;">
            <div class="container">
			  <ul class="tabs">
			    <li class="tab-link current" data-tab="tab-1">관리자 정보 수정</li>
			  </ul>
  			  <div id="tab-1" class="tab-content current">
  			  	<div class="form-group" >
						...
						<table border =1; class="tb_css">
							...
							<tr>
								<td>* Grade</td>
								<td><input type="text" name="admin_grade"/></td>
							</tr>
							<tr>
								<td>* Name</td>
